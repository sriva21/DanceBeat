...
// export default function Dancer({ move }: DancerProps) {
...
//   // -----------------------------------------------------
//   const idleClip =
//     clips.step || clips.kickstep || clips.samba1 || null;
...
//   // -----------------------------------------------------
//   // PERFECT SCALE + POSITION (HEAD VISIBLE)
//   // -----------------------------------------------------
//   return (
//     <primitive
//       ref={root}
//       object={model.scene}
//       scale={1.8}        // good size
//       position={[0, -1.2, 0]} // move model down to show head & feet
//     />
//   );
// }
// src/components/Dancer.tsx
